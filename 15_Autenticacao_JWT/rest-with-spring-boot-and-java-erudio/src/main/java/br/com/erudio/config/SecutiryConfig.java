...
@Configuration
@EnableWebSecurity // para fazer o WEB SECURITY CONFIGURATION
public class SecutiryConfig {
	...
	public PasswordEncoder passwordEncoder() {
		// esse metodo fala como o spring vai encriptar as senhas em comparação as
		// senhas que estão no banco de dados
